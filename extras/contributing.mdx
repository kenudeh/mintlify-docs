...
<Accordion title="Learn how the code works">
...
The backend consists of an API, which is documented in the [API Reference section.](/api-reference/introduction). The API is made up of of functions to handle storing and reading data
...
<Tip>
  The API documentation is in the [API Reference section.](/api-reference/introduction)
</Tip>
...
* Do your work in a branch from the development branch, then create a pull request when you're ready
  ...
  * Write about the changes you've made in `CHANGELOG.md`, following the format there
